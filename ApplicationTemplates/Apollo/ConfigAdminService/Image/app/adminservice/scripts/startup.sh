...
LOG_DIR=/data/apollo/adminservice/logs
...
export JAVA_OPTS="$JAVA_OPTS -Deureka.instance.ip-address=${ADMINSERVICE_REGISTRY_TO_EUREKA_URL_OR_IP} -Deureka.instance.non-secure-port=${ADMINSERVICE_REGISTRY_TO_EUREKA_PORT}"
