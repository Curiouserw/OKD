...
LOG_DIR=/data/apollo/configservice/logs
...
export JAVA_OPTS="$JAVA_OPTS -Deureka.instance.ip-address=${CONFIGSERVICE_REGISTRY_TO_EUREKA_URL_OR_IP} -Deureka.instance.non-secure-port=${CONFIGSERVICE_REGISTRY_TO_EUREKA_PORT}"
